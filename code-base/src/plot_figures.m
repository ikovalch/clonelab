...
function fig_initial_dcr_from_rpt()
    ...
    labels = {'R_{10s, 90% SOC} (m\Omega)', ...
              'R_{10s, 50% SOC} (m\Omega)', ...
              'R_{10s, 5% SOC} (m\Omega)'};
    varnames = {'dcr_10s_90_soc_at_c3_mohm', ...
                'dcr_10s_50_soc_at_c3_mohm', ...
                'dcr_10s_5_soc_at_c3_mohm'};
...
function fig_formation_performance_distributions()
    ...
    varnames = {'form_final_discharge_capacity_ah', ...
                ...
                'form_6hr_rest_delta_voltage_mv'};
